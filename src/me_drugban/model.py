...
from .ban_module.ban import SimpleFusion  # or BANLayer if you implement attention
from .MLP.model_head import MLPDecoder

class DrugBAN(nn.Module):
    def __init__(self, drug_gnn_params, protein_params, mlp_params):
